...
#print(googletrans.LANGUAGES.get("Alemão"))
...
while(resposta != 0):
    ...
    if (resposta == 1):
        ...
        print(f"A tradução será feita do português para {idioma}.")
        print("\nA tradução obtida foi: "+traduzir_texto(texto=input("Digite a frase a ser traduzida: ")))
        resposta = -1
